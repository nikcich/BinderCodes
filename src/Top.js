...
const Top = (props) => {
    ...
    const getTop = () => {
        axios.get('https://api.cichosz.dev/users/top').then(response => {
            ...
            {topitems.map((item, idx) => (
                <div key={idx} className="topImageHolder">
                    ...
                    <div className="topImage"> 
                        <img src={'https://api.cichosz.dev/getimage/'+item.Accounts_id} id="displayImg1" className="displayImg1" alt="Loading..."></img>
                    </div>
                </div>
            ))}
        </div>
